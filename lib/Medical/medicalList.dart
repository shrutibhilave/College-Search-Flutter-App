...
class medicalList extends StatefulWidget {
  @override
  _medicalList createState() => _medicalList();
}

class _medicalList extends State<medicalList> {
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: <Widget>[
                                ...
                                Text("     ${college=snap[index]['gov']}",style: GoogleFonts.aBeeZee(fontSize: 15.0,fontWeight: FontWeight.w200,color: Colors.green),),
                              ],
                            ),
                          ),
                        ],
  ...
  getData() async{
    String theUrl="http://sayaba.co.in/shruti/medicalList.php";
