...
class hotelManagementList extends StatefulWidget {
  @override
  _hotelManagementList createState() => _hotelManagementList();
}

class _hotelManagementList extends State<hotelManagementList> {
  ...
  getData() async{
    String theUrl="http://sayaba.co.in/shruti/hotelManagementList.php";
